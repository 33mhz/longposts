...
$app_clientId     = API_ID;
$app_clientSecret = API_SECRET;

// this must be one of the URLs defined in your App.net application settings
$app_redirectUri  = 'https://longposts.net/callback.php';
...
$app_scope        =  array(
	...
	// 'public_messages', // Send and receive public messages as this user
	 'messages:net.longposts.longpost', // Send and receive public and private messages as this user
