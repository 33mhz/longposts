...
if (isset($_SESSION['logged_in'])) {
    ...
    if (isset($_POST['body']) && isset($_POST['title'])) {
        ...
        if (isset($_POST['channel_id'])) {
            $channel_data = $app->getChannel($_POST['channel_id'],['include_channel_raw'=>1,'include_message_raw'=>1]);
            $channel_data['raw'][0]['value']['category'] = $category;
            $channel_data['raw'][0]['value']['title'] = $title;
