...
try {
	...
	$single_page = true;
	$page_title = htmlentities($longpost['raw'][0]['value']['title'], ENT_QUOTES) . ' &ndash; Long posts';
	...
	if (!empty($longpost['raw'][0]['value']['category'])) {
		echo 'Filed Under: <a href="/category/'.$longpost['raw'][0]['value']['category'].'">"'.$longpost['raw'][0]['value']['category'].'"</a><br>
		';
	}
